...
namespace RatEncounterDesktop.Worlds
{
    ...
    public partial class RenderWorld
    {
        ...
        //Object Storage
        private static string resourcePath = "RatEncounterDesktop.Resources.";
        ...
        {
            MainCamera = new Camera(Kirali.MathR.Vector3.Zero, Kirali.MathR.Vector3.Zero, width, height);
            Init();
        }
        ...
        {
            MainCamera = new Camera(MainCamera.position, MainCamera.rotation, x, y);
        }
    }
