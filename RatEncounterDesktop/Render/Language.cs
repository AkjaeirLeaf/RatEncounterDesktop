    ...
    public partial class Language
    {
        ...
        public virtual void BuildGlyphsets_Letters(string charline)
        {
            ...
            for (int ix = 0; ix < break_.Length; ix++)
            {
                ...
                glyphset[ix].row = row;
                glyphset[ix].col = col;
                glyphset[ix].cropLeft =  0.1;
                glyphset[ix].cropRight = 0.1;
                col++;
        ...
        public virtual void BuildGlyphsets_SymbolsNumeric(string charline)
        {
            ...
            for (int ix = 0; ix < break_.Length; ix++)
            {
                ...
                col++;
                if (col >= symtex_COLS_COUNT) { row++; col = 0; }
        ...
        public virtual Vector2[] GetGlyphTile(Glyph gly, bool uppercase, out Texture2D tex, bool isTinyLetter = false)
        {
            ...
            double left_kern, right_kern;
            left_kern  = gly.cropLeft;
            right_kern = gly.cropRight;
            ...
            switch (gly.category)
            {
                case GlyphType.LETTER:
                    ...
                    pos_X = (gly.col + left_kern) / lettex_COLS_COUNT;
                    pos_Y = (double)gly.row / lettex_ROWS_COUNT;
                    end_X = ((double)(gly.col + 1 - right_kern)) / lettex_COLS_COUNT;
                ...
                case GlyphType.SYMBOL_MISC:
                    ...
                    pos_X = (gly.col + left_kern) / symtex_COLS_COUNT;
                    pos_Y = (double)gly.row / symtex_ROWS_COUNT;
                    end_X = ((double)(gly.col + 1 - right_kern)) / symtex_COLS_COUNT;
